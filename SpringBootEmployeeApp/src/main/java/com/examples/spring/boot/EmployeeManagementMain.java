...
import com.examples.spring.boot.exception.EmployeeValidationException;
import com.examples.spring.boot.exception.NoEmployeeFoundException;
import com.examples.spring.boot.model.Employee;
import com.examples.spring.boot.service.EmployeeService;

@SpringBootApplication
public class EmployeeManagementMain implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(EmployeeManagementMain.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		empService = (EmployeeService) context.getBean("employeeService");
